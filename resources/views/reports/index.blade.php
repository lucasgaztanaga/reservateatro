                            ...
                            @if($r->reservation_date > now()->toDateString())
                              ...
                              <td>
                                <div class="pull-right btn-group-vertical" role="group">
                                    <a href="{{ url('/reports/report/'. $r->id) }}" title="Seleccionar puestos"  class="btn btn-primary btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Ver reporte</a>
                                </div>
                              </td>
                            @else 
                              ...
                              <td>
                                <div class="pull-right btn-group-vertical" role="group">
                                    <a href="{{ url('/reports/report/'. $r->id) }}" title="Seleccionar puestos"  class="btn btn-primary btn-xs"><i class="fa fa-eye" aria-hidden="true"></i> Ver reporte</a>
                                </div>
                              </td>
                            @endif
                        </tr>
